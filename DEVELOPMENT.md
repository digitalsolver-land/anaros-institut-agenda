...
```bash
git remote add encore encore://anaros-institut-agenda-828i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/anaros-institut-agenda-828i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/anaros-institut-agenda-828i/settings/integrations/github)
